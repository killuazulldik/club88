                    ...
                    do{
                        ...
                        $sql = "INSERT INTO students (s_name, s_email, s_age, s_phone, s_address , s_created_at, s_status)".
                        "VALUES ('$name','$email','$age','$phone','$address','$created_at','$status')" ;
                        ...
                        // Checking email format using regular expression
                        ...
                        $successMessage = "enroll successfully!";
